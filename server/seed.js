...
const memberBookingData = [
  ...
  { name: "Zoe Kim",        email: "zoe.kim@email.com",        phone: "+16195550201", membershipType: "basic",     joinDaysAgo: 8,   bookingOffsets: [5] },
  { name: "Ben Torres",     email: "ben.torres@email.com",     phone: "+16195550202", membershipType: "premium",   joinDaysAgo: 15,  bookingOffsets: [12, 10] },

  // ── REGULAR (last booking ≤ 14 days ago) ────────────────────────────
  { name: "Avery Chen",     email: "avery.chen@email.com",     phone: "+16195550101", membershipType: "unlimited", joinDaysAgo: 540, bookingOffsets: [2, 9, 18, 26, 35, 44, 52, 61, 70, 78, 85, 91] },
  { name: "Jordan Malik",   email: "jordan.malik@email.com",   phone: "+16195550102", membershipType: "premium",   joinDaysAgo: 365, bookingOffsets: [5, 14, 22, 31, 40, 50, 60, 72, 85] },
  { name: "Priya Nair",     email: "priya.nair@email.com",     phone: "+16195550103", membershipType: "unlimited", joinDaysAgo: 243, bookingOffsets: [1, 8, 16, 24, 33, 42, 51, 60, 68, 77, 85] },
  { name: "Sofia Reyes",    email: "sofia.reyes@email.com",    phone: "+16195550104", membershipType: "premium",   joinDaysAgo: 420, bookingOffsets: [3, 11, 20, 28, 37, 46, 56, 68, 80, 92] },
  { name: "Marcus Webb",    email: "marcus.webb@email.com",    phone: "+16195550105", membershipType: "basic",     joinDaysAgo: 182, bookingOffsets: [7, 17, 28, 38, 50, 62, 75, 88] },

  // ── AT-RISK (last booking 15–19 days ago) ───────────────────────────
  { name: "Nina Kovacs",    email: "nina.kovacs@email.com",    phone: "+16195550106", membershipType: "unlimited", joinDaysAgo: 305, bookingOffsets: [16, 32, 48, 65, 82, 99, 115, 130] },
  { name: "Ethan Park",     email: "ethan.park@email.com",     phone: "+16195550107", membershipType: "premium",   joinDaysAgo: 214, bookingOffsets: [18, 35, 52, 70, 88, 105, 120] },
  { name: "Chloe Andersen", email: "chloe.andersen@email.com", phone: "+16195550108", membershipType: "basic",     joinDaysAgo: 122, bookingOffsets: [15, 29, 44, 60, 76, 92] },
  { name: "Aisha Patel",    email: "aisha.patel@email.com",    phone: "+16195550109", membershipType: "premium",   joinDaysAgo: 365, bookingOffsets: [19, 36, 54, 71, 89, 107, 125, 142, 158, 173] },

  // ── LAPSED (last booking > 21 days ago, or no bookings) ─────────────
  { name: "Liam Okafor",    email: "liam.okafor@email.com",    phone: "+16195550110", membershipType: "basic",     joinDaysAgo: 608, bookingOffsets: [30, 65, 100, 135] },
  { name: "Ryan Nguyen",    email: "ryan.nguyen@email.com",    phone: "+16195550111", membershipType: "basic",     joinDaysAgo: 305, bookingOffsets: [] },
  { name: "Diego Vargas",   email: "diego.vargas@email.com",   phone: "+16195550112", membershipType: "unlimited", joinDaysAgo: 730, bookingOffsets: [40, 80, 120, 165, 200] },
  { name: "Yuki Tanaka",    email: "yuki.tanaka@email.com",    phone: "+16195550113", membershipType: "premium",   joinDaysAgo: 243, bookingOffsets: [28, 60] },
];
