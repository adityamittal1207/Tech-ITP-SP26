      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <div className="max-w-md rounded-xl border border-border bg-card p-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Copy <code className="text-xs">client/.env.example</code> to{" "}
            <code className="text-xs">client/.env</code> and add your Firebase web app
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="font-display text-2xl font-semibold">Tether</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "signin" ? "Sign in to your studio dashboard" : "Create your studio account"}
          </p>
        </div>
